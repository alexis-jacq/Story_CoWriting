...
for i in range(N):
    ...
    for j in range(n):
        ...
        action1 = teacher.update_models(None,model_percepts1,model_actions1,"MM1_understand")
        action2 = learner.update_models(None,model_percepts2,model_actions2,"MM1_understand")
