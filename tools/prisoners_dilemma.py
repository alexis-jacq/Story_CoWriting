...
for i in range(N):
    ...
    for j in range(2):
        ...
        # robert's turn
        if action2 in play:
            action1 = robert.update_models(possible_actions=play,models_percepts=copy.copy(model_percepts1))
            ...
            action1 = robert.update_models(possible_actions=None,models_percepts=copy.copy(model_percepts1))
            print "model_percepts1 (b) ="
            print model_percepts1
            print "model_percepts2 (b) ="
            print model_percepts2
            print "================================="
        ...
        # pierrot's turn
        if action1 in play:
            action2 = pierrot.update_models(possible_actions=play,models_percepts=copy.copy(model_percepts2))
            model_percepts1,model_percepts2,r1,r2 = world_update_play(action1,action2)
            print "model_percepts2 modified ! !!!!!!"
            print "================================="
            cumrew1.append(r1)
            ...
            action2 = pierrot.update_models(possible_actions=None,models_percepts=copy.copy(model_percepts2))
            if action1 and action2:
                model_percepts1,model_percepts2 = world_update_communicate(action1,action2)
                print "model_percepts2 modified ! !!!!!!"
                print "=================================="
    ...
    CUMREW1+=np.array(cumrew1)
    CUMREW2+=np.array(cumrew2)
