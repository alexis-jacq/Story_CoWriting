...
class Characters(models.Model):
    ...
    idro = models.ForeignKey('Role', models.DO_NOTHING, db_column='idRo')  # Field name made lowercase.
    idjo = models.ForeignKey('Job', models.DO_NOTHING, db_column='idJo')  # Field name made lowercase.
    idsp = models.ForeignKey('Species', models.DO_NOTHING, db_column='idSp')  # Field name made lowercase.
...
class Ticks(models.Model):
    ...
    tickscol = models.CharField(db_column='Tickscol', max_length=45, blank=True, null=True)  # Field name made lowercase.
